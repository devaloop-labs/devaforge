...
switch (platform) {
  case "win32":
    binaryName = "devaforge-x86_64-pc-windows-msvc.exe";
    break;
  case "darwin":
    binaryName = "devaforge-x86_64-apple-darwin";
    break;
  case "linux":
    binaryName = "devaforge-x86_64-unknown-linux-gnu";
    break;
}
...
if (binaryName !== "") {
  ...
  const url = `https://github.com/devaloop-labs/devaforge/releases/download/v${versionString}/${binaryName}`;
